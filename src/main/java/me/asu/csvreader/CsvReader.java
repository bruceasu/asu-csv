...
public class CsvReader implements AutoCloseable {
     ...
     * @param charset The {@link Charset Charset} to use while parsing the data.
     */
     ...
     * qualified data.
     *
     * @param escapeMode The way to escape an occurance of the text qualifier inside qualified
     * data.
     ...
     *
     * @return The count of headers read in by a previous call to {@link CsvReader#readHeaders
     * readHeaders()}.
     */
     ...
     * @return A {@link CsvReader CsvReader} object using the String of data as the source.
     */
            ...
            do {
                if (dataBuffer.Position == dataBuffer.Count) {
                    ...
                    if (userSettings.UseTextQualifier
                        ...
                        if (startedColumn
                                || columnsCount > 0
                                || (!userSettings.SkipEmptyRecords && (currentLetter == Letters.CR
